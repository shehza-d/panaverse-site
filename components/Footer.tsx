...
export default function Footer() {
  return (
    <footer
      className="flex h-[28rem] flex-col justify-end"
      style={{
    ...
    >
      <div className="mx-20 flex">
        <div className="bdr flex-1">
          ...
          >
            <FiMapPin className="text-xl text-accent" /> &nbsp; Plot 245/2 M,
          ...
          >
            <FaWhatsapp className="text-xl text-accent" /> &nbsp; +92 308
            2220203
          </Link>
          <Link
            ...
            className="flex items-center p-1 text-slate-100 hover:text-accent"
          >
            <MdOutlineMail className="text-xl text-accent" /> &nbsp;
            education@piaic.org
          </Link>
        ...
        <form className="flex flex-1 flex-col justify-evenly border-2  border-yellow-500 text-accent">
          <label className="text-2xl font-semibold" htmlFor="newsLetter">
            Subscribe
          </label>
          <input
            className="min-w-0 rounded-lg border-0 bg-white/5 px-3.5 py-4 text-white shadow-sm outline-none ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-accent sm:text-sm sm:leading-6"
            type="email"
            name="newsLetter"
            autoComplete="email"
            required
